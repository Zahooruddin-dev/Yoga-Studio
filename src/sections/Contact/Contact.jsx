...
function ContactForm() {
    function reminder(){
        alert('The following site is only for display, due to which the contact us form is non functional and disabled for now. Thanks')
    }
    return (
            ...
            <div className="section" id="contact">
                <div className="container contact-container">
                    ...
                    <form className="contact-form p-3">
                        ...
                        {/* Submit Button */}
                        <button type="submit" className="btn-submit" onClick={reminder}>
                            Submit
                        </button>
                    </form>
                </div>
